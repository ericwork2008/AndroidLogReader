...
//    this.setIcon(null);
    ...
    setModel(new santhosh.TristateButtonModel(TristateState.DESELECTED));
  ...
  public void setModel(ButtonModel newModel) {
    ...
    if (model instanceof santhosh.TristateButtonModel)
  ...
  //Convenience cast
  public santhosh.TristateButtonModel getTristateModel() {
    return (santhosh.TristateButtonModel) super.getModel();
  }
}
